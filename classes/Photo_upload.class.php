<?php 
	class Photo_upload{
		private $photo_to_upload;//esialgu saadame seda siia laadimise lehelt, parast teeb class seda ise
		...
		function __construct($photo, $file_type){
			...
			$this->check_image();
			if(empty($this->error));{
			$this->my_temp_image=$this->create_image_form_file($this->photo_to_upload["tmp_name"],$this->file_type);
		}}
		function __destruct(){
		...
		private function create_image_form_file($file,$file_type = "png"){
